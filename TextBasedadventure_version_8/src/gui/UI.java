...
public class UI {
	...
	public void drawOptions() {
		...
		g2.drawString("SAVE", (int) x - (getXStringLength("SAVE") / 2), (int) y);
	...
	public void drawInventory() {
	    ...
	    g2.drawString(pp.player.name + "'s Inventory", getXForCenteredText(pp.player.name + "'s Inventory"), (int)y);
	...
	public void drawMessage() {
	    ...
	    if(pp.animH.tempColumn % 3 == 0 && pp.animH.tempColumn != 0) {
    		g2.drawString(">", (int) x + (int) (pp.tileSizeX * 7.2), (int) y - (pp.tileSizeY / 3));
	...
	public void drawPlayerStats() {
			...
			g2.drawString("HP: " + pp.player.hp , (int) x, (int) y);
